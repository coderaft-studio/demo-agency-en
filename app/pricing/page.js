...
const PricingContent=dynamic(()=>import("./PricingContent"),{ssr:false,loading:()=><div style={{minHeight:"60vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0a0f1e"}}><div style={{width:"40px",height:"3px",background:"linear-gradient(90deg,#6366f1,#8b5cf6)",animation:"axl 1.2s ease-in-out infinite alternate",borderRadius:"3px"}}/><style>{`@keyframes axl{to{width:80px}}`}</style></div>});
